    ...
    <div className="login-page">
        ...
        <div className='sloganBox'>
            ...
            <h1 className='slogan'>
                ...
                Don’t want to be the one to bring up money? <b></b> State your budget, anonymously. <br></br> <li></li> Getting ignored in the group chat? <b></b> Have your preferences heard, with Travel Herd.
            </h1>
